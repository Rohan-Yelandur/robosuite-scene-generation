ACTION_DICTS = {
    ...
    "square": {
        ...
        14: "Change the robot color to red.",
        15: "Change the robot color to green.",
        16: "Change the robot color to blue.",
        17: "Change the robot color to gray.",
        18: "No perturbation applied.",
    },
    "lift": {
